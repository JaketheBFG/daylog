    ...
    <nav className="nav">
      ...
      <div className="nav-right">
        ...
        {showSettings&&<>
          ...
          <div style={{position:"absolute",top:0,right:0,zIndex:100,background:"var(--surface2)",border:"1px solid var(--border)",borderRadius:14,padding:"16px",width:"min(220px, 80vw)",display:"flex",flexDirection:"column",gap:10,boxShadow:"0 8px 32px rgba(0,0,0,0.4)"}}>
